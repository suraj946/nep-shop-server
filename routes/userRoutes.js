...
import { changePassword, forgotPassword, getMyProfile, login, logout, register, resetPassword, updatePassword, updatePic } from "../controllers/userControllers.js";
...
router.route("/updateprofile").put(authenticate, updatePassword);
